                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            if (isset($_SESSION['msg'])) {
                                                ...
                                                <strong>Well done!</strong> ' . $_SESSION['msg'] . '</div>';
                                                unset($_SESSION['msg']);
                                            }
                                            if (isset($msg)) {
                                                echo '<div class="alert alert-success left-icon-alert" role="alert">
                                            ...
                                            <!-- Import Excel Form -->
                                            <form action="import-students.php" method="post"
                                                enctype="multipart/form-data">
                                                <div class="form-group">
                                                    <label for="file" class="col-sm-2 control-label">Import Excel
                                                        File</label>
                                                    <div class="col-sm-10">
                                                        <input type="file" name="import_file" class="form-control"
                                                            id="import_file" required="required" accept=".xlsx, .xls">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-sm-offset-2 col-sm-10">
                                                        <button type="submit" name="import"
                                                            class="btn btn-success">Import Students</button>
                                                    </div>
                                                </div>
                                            </form>
